...
<head>
    ...
    <meta name="description" content="Donate and help Miraheze's mission keep going for years to come. Donate to Miraheze today!" />
    <meta name="google-site-verification" content="9BKrnuH_ZCD7XGAk50SjbeUEZKjfJOQ02Dmo5pMZut0" />
    <meta name="twitter:description" content="Donate and help Miraheze's mission keep going for years to come. Donate to Miraheze today!" />
    <meta property="og:description" content="Donate and help Miraheze's mission keep going for years to come. Donate to Miraheze today!" />
                    ...
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            ...
                            <nav aria-label="breadcrumb">
								<p class="breadcrumb-item text-white active justify-content-center" aria-current="page">
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container px-lg-5 text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                    <form name="donate" id="donateForm" style="display: block; width: 100%; padding: 0.75rem 1rem; font-size: 1rem; line-height: 1.5; background-clip: padding-box; border: 1px solid #ced4da; -webkit-appearance: none; -moz-appearance: none; appearance: none; border-radius: 0.25rem;">
					<div class="form-control-lg mb-0 pb-2 col-lg-8 mx-auto">
						...
						<a id="donationHref" class="btn btn-primary rounded-pill py-3 px-5" href="https://www.paypal.com/donate/?hosted_button_id=Q8ZN29LJVXP7L" title="<?php echo getTranslation( 'donate-heading' ); ?>">
							<?php echo getTranslation( 'donate-heading' ); ?>
						</a>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-flag-checkered me-3"></i><a href="https://issue-tracker.miraheze.org" style="color: white;" title="Issue trakcer">Issue tracker</a></p>
