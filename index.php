        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <img rel="preload" fetchpriority="high" as="image" class="logo" src="https://miraheze.org/img/Miraheze-Logo.svg" alt="Miraheze Logo" />
            ...
            <div class="container-fluid hero-header">
                <div class="container px-lg-5">
                    <div class="row g-5 align-items-end">
                        ...
                        <div class="col-lg-6 text-center text-lg-start">
                            <img rel="preload" fetchpriority="high" as="image" class="img-fluid" src="https://miraheze.org/img/hero.webp" alt="Join Miraheze!" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <h1 class="text-accent mb-2" data-toggle="counter-up">75,000</h1>
                        <p class="text-accent mb-0">
                    ...
                    <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <h1 class="text-accent mb-2" data-toggle="counter-up">800,000</h1>
                        <p class="text-accent mb-0">
